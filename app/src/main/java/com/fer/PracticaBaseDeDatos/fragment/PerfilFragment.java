...
import com.fer.PracticaBaseDeDatos.adapter.PerfilAdaptador;
...
public class PerfilFragment extends Fragment {
    ...
    public void inicializarAdaptador(){
         ...
         ****/
        PerfilAdaptador adaptador = new PerfilAdaptador(misMascotas, getActivity()); //y ahora le pasamos tb el activity, para el tema del click
